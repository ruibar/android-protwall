...
public class ActivityLog extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = "ProtWall.Log";
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.menu_block:
                                ...
                                Intent main2 = new Intent(ActivityLog.this, ActivityMain.class);
                                main2.putExtra(ActivityMain.EXTRA_SEARCH, Integer.toString(uid));
                                startActivity(main2);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        File pcap_file = new File(getCacheDir(), "ProtWall.pcap");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        final File pcap_file = new File(getCacheDir(), "ProtWall.pcap");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_log_support:
                ...
                intent.setData(Uri.parse("https://github.com/M66B/ProtWall/blob/master/FAQ.md#FAQ27"));
    ...
    private Intent getIntentPCAPDocument() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            intent.putExtra(Intent.EXTRA_TITLE, "ProtWall_" + new SimpleDateFormat("yyyyMMdd").format(new Date().getTime()) + ".pcap");
        }
        return intent;
    }
            ...
            protected Throwable doInBackground(Object... objects) {
                ...
                try {
                    ...
                    if (data.hasExtra("org.openintents.extra.DIR_PATH"))
                        target = Uri.parse(target + "/ProtWall.pcap");
                    Log.i(TAG, "Export PCAP URI=" + target);
                    out = getContentResolver().openOutputStream(target);

                    File pcap = new File(getCacheDir(), "ProtWall.pcap");
